...
# This code is based on https://github.com/craston/MARS/blob/master/utils1/extract_frames_flows.py
  ...
  for ic,cls in enumerate(class_list):
    ...
    for v in tqdm(vlist):
        ...
        try:  
            ...
            # extract flows 
            os.system('export CUDA_VISIBLE_DEVICES=%d; /home/aistudio/MARS_paddle/utils1/tvl1_videoframes "%s" %d "%s" '%(gpu, os.path.join(outdir, '%05d.jpg'), nframes, os.path.join(outdir,'%05d_flow256crop.flo') ))
