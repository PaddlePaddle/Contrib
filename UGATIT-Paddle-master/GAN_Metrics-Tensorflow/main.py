...
def frechet_inception_distance() :
    ...
    # Run images through Inception.
    inception_images = tf.compat.v1.placeholder(tf.float32, [BATCH_SIZE, 3, None, None])
    real_activation = tf.compat.v1.placeholder(tf.float32, [None, None], name='activations1')
    fake_activation = tf.compat.v1.placeholder(tf.float32, [None, None], name='activations2')
