...
def main(args):
    ...
    PeMS = data_gen_custom(args.input_file, args.label_file, args.city_file, args.n_route, args.n_his,
                    args.n_pred, (args.n_val, args.n_test))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_file', type=str, default='dataset/mock_data')
