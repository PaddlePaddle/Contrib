...
import os, glob, sys
data_path=r'/home/aistudio/work/paddle/cityscapesscripts/'
# cityscapes imports
sys.path.append( os.path.normpath( os.path.join( os.path.dirname( data_path ) ,  'helpers' ) ) )
sys.path.append( os.path.normpath( os.path.join( os.path.dirname( data_path )  ) ) )
...
def main():
    ...
    if 'CITYSCAPES_DATASET' in os.environ:
        ...
        cityscapesPath = os.path.join(os.path.dirname(os.path.realpath(data_path)),'..','..')
    # how to search for all ground truth
    cityscapesPath = r'/home/aistudio/data'
