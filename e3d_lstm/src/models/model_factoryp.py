  ...
  def __init__(self, configs):
    ...
    with fluid.program_guard(self.train_program, self.start_program):
      ...
      with fluid.unique_name.guard():
        ...
        # fluid.layers.Print(output_list[0], message='output 0: ')
        # fluid.layers.Print(output_list[1], message='output 1: ')
        ...
        # fluid.layers.Print(output_list[1], message='after defining optimizer')
        self.train_op = adam.minimize(self.loss)
        # fluid.layers.Print(output_list[1], message='after optimizing')
        # else:
