...
class DMRLayer(nn.Layer):
    def __init__(self, user_size, lr, global_step, cms_segid_size,
                 cms_group_id_size, final_gender_code_size, age_level_size,
                 pvalue_level_size, shopping_level_size, occupation_size,
        ...
        self.position_his = paddle.to_tensor(np.arange(self.history_length))
        ...
        self.dm_position_his = paddle.to_tensor(np.arange(self.history_length))
    ...
    def forward(self, inputs_tensor, with_label=0):
        ...
        self.aux_loss, self.dm_user_vector, scores = self._deep_match(
            ...
            paddle.cast(self.match_mask, 'float32'), self.cate_his,
            self.main_embedding_size, self.dm_item_vectors_var.weight,
