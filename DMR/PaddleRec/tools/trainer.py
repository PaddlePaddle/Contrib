...
if __name__ == '__main__':
    ...
    args = parse_args()
    best_auc = 0.64
    best_lr = [0.008, 0.0085, 0.009, 0.0095, 0.001] * 2

    # for lr in [0.006, 0.0065, 0.007, 0.0075, 0.008, 0.0085, 0.009]:
    ...
    print(f'Best AUC: {best_auc}, Best learning_rate: {best_lr[-1]}')
